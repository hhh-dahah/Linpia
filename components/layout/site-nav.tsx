...
export function SiteNav() {
  ...
  return (
    <nav className="-mx-4 overflow-x-auto px-4 pb-1 sm:-mx-6 sm:px-6 lg:mx-0 lg:px-0">
      <div className="flex min-w-max items-center gap-2 text-sm font-medium text-muted">
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                "active:scale-[0.96] active:bg-[rgba(36,91,219,0.12)] active-text-primary",
                "hover:bg-[var(--primary-soft)] hover-text-primary",
                "motion-reduce:transition-none",
                isActive
                  ? "bg-[var(--primary-soft)] text-primary shadow-[inset_0_0_0_1px_rgba(36,91,219,0.08)]"
                  : "bg-transparent",
              )}
            >
              {item.label}
